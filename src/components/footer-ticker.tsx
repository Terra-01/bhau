...
const MESSAGES = [
  ...
  "LIVE QUOTES REFRESH ~30S DURING NSE HOURS · NSE-DIRECT WITH YAHOO FALLBACK",
  ...
  "EVERY AGENT DECISION LIVES ON A PUBLIC HASH-CHAINED LEDGER — REPLAYABLE FROM GENESIS",
