...
export function InsightLine({ children, meta }: { children: ReactNode; meta?: ReactNode }) {
  ...
  return (
    <div
      ...
      className="pressable mt-auto flex shrink-0 cursor-pointer items-baseline justify-between gap-2 border-t border-ash px-2.5 py-[3px] text-[8.5px] leading-tight text-fog transition-colors duration-150 [@media(hover:hover)]:hover:bg-paper/60"
    >
